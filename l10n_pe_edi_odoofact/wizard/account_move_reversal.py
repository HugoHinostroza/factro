...
class AccountMoveReversal(models.TransientModel):
    ...
    l10n_pe_edi_reversal_type_id = fields.Many2one(
        'l10n_pe_edi.catalog.09', string='Credit note type', help='Catalog 09: Type of Credit note', default=_get_type_debit_note)
    ...
    def reverse_moves(self):
        ...
        return super(AccountMoveReversal, self.with_context(l10n_pe_edi_reversal_type_id=l10n_pe_edi_reversal_type_id,
